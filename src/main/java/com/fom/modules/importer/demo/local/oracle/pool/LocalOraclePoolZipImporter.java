 ...
 *
 */
public class LocalOraclePoolZipImporter extends ZipImporter<LocalZipImporterConfig, Map<String,String>>{
	 ...
	 */
	@Override
	protected void praseLineData(LocalZipImporterConfig config, List<Map<String,String>> lineDatas, String line, long batchTime)
			throws Exception {
		log.info("解析行数据:" + line);
	 ...
	 */
	@Override
	protected void batchProcessLineData(LocalZipImporterConfig config, List<Map<String,String>> lineDatas, long batchTime)
			throws Exception {
