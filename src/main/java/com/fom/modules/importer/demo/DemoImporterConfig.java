 ...
 *
 */
public class DemoImporterConfig extends ImporterConfig {
	
	private String myconf;
	
	//...
	
	protected DemoImporterConfig(String name) {
		super(name);
	}
	...
	public boolean equals(Object o) {
		if(!(o instanceof DemoImporterConfig)){
			return false;
		}
		if(o == this){
			return true;
		...
		DemoImporterConfig config = (DemoImporterConfig)o;
