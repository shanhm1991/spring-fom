...
public class InputEsExampleTask extends ParseTextTask<Map<String, Object>> {
	...
	public InputEsExampleTask(String sourceUri, int batch, String esIndex, String esType, File esJson) {
